...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self == [super initWithFrame:frame]) {
        ...
        self.bgView = [[UIView alloc] initWithFrame:CGRectMake(0, KScreenHeight, KScreenWidth, 230)];
        ...
        [self.cancelBtn setTitleColor:kColor(191, 191, 191) forState:UIControlStateNormal];
        ...
        [self.completionBtn setTitleColor:kColor(42, 42, 42) forState:UIControlStateNormal];
