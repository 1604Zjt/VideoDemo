...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //添加图片cell点击事件
    _singleTap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(tapProfileImage:)];
    _singleTap.numberOfTapsRequired = 1;
    cell.profilePhoto .userInteractionEnabled = YES;
    [cell.profilePhoto  addGestureRecognizer:_singleTap];
...
{
    CGFloat width = (kScreenW - 20 * 2 - 13 * 2) / 3;
...
//        [cell.profilePhoto removeGestureRecognizer:_singleTap];
...
- (void)changeCollectionViewHeight{
    ...
    if (_collectionFrameY) {
        _pickerCollectionView.frame = CGRectMake(0, _collectionFrameY, [UIScreen mainScreen].bounds.size.width, ((float)(kScreenW - 20 * 2 - 13 * 2) / 3 +20.0)* ((int)(_arrSelected.count)/3 +1)+20.0);
    }
    else{
        _pickerCollectionView.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, ((float)(kScreenW - 20 * 2 - 13 * 2) / 3 +20.0)* ((int)(_arrSelected.count)/3 +1)+20.0);
    }
...
- (void)updatePickerViewFrameY:(CGFloat)Y{
    ...
    _collectionFrameY = Y;
    _pickerCollectionView.frame = CGRectMake(0, Y, [UIScreen mainScreen].bounds.size.width, ((float)(kScreenW - 20 * 2 - 13 * 2) / 3 +20.0)* ((int)(_arrSelected.count)/3 +1)+20.0);
}
